...
CtrlPanel::CtrlPanel(Game& g) :
    ...
    prevMouseX(),
    mouseOldCoord(),
    fps("",Application::getFont(FreeMono),fontSize),
    player("Player : 1",Application::getFont(FreeMono),fontSize),
    rotation("",Application::getFont(FreeMono),fontSize),
    power("Power : ",Application::getFont(FreeMono),fontSize),
    fire("FIRE",Application::getFont(FreeMono),fontSize),
